...
describe('PlanesWhichAreStoredInTheAirport', () => {
    ...
    it('MilitaryPlanesWithTransportType', () => {
        let airport = new Airport(planes);
        let transportMilitaryPlanes = airport.getMilitaryPlanes();
        let flag = false;
    ...
    it('PassengerPlaneWithMaxPassengersCapacity', () => {
        let airport = new Airport(planes);
    ...
    it('PassengerPlaneWithMaxLoadCapacity', () => {
        let airport = new Airport(planes);
    ...
    it('HasAtLeastOneBomberInMilitaryPlanes', () => {
        let airport = new Airport(planes);
    ...
    it('ExperimentslPlanesHasClassificationLevelHigherThanUnclassified', () => {
        let airport = new Airport(planes);
